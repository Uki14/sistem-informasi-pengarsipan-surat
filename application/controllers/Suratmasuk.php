...
class SuratMasuk extends CI_Controller
{
    ...
    public function update_disposisi()
    {
        ...
        $id_suratmasuk = $this->db->get_where('disposisi', ['id_disposisi' => $id_disposisi])->row()->id_suratmasuk;
        $this->db->update('disposisi', $data, ['id_disposisi' => $id_disposisi]);
        $this->session->set_flashdata('success', 'Data berhasil diubah!');
        redirect('suratmasuk/disposisi/' . $id_suratmasuk);
    }
