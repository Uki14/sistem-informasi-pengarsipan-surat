                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="javascript:;" <?php
                                                                                ...
                                                                                ?> id="btn-edit-disposisi" data-toggle="modal" data-target="#modal-edit-disposisi" class="badge badge-primary d-block mb-1">edit</a>
                                                        <a href="<?= base_url('suratmasuk/print_disposisi/' . $ds->id_disposisi) ?>" target="_blank" class="badge badge-success d-block mb-1">cetak</a>
                                                        <a href="<?= base_url('suratmasuk/delete_disposisi/' . $ds->id_disposisi . '?id_suratmasuk=' . $suratmasuk['id_suratmasuk']) ?>" onclick="return confirm('Hapus disposisi ini?')" class="badge badge-danger d-block mb-1">hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
...
<div class="modal fade" id="modal-edit-disposisi">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form role="form" action="<?= base_url('suratmasuk/update_disposisi/') ?>" method="POST" enctype="multipart/form-data">
                <div class="modal-header">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Instruksi/Informasi</label>
                                    <input type="text" name="instruksi" id="instruksi" class="form-control" placeholder="Instruksi..">
                                </div>
                                <div class="form-group">
                                    <label>Catatan</label>
...
<script>
    document.querySelectorAll('#btn-edit-disposisi').forEach(item => {
        item.addEventListener('click', e => {
            const get = attr => e.target.getAttribute(`data-${attr}`)

            document.querySelectorAll('#pengisi')[1].value = get('pengisi')
            document.querySelectorAll('#tujuan')[1].value = get('tujuan')
            document.querySelector('#instruksi').value = get('instruksi')
            document.querySelector('#catatan').value = get('catatan')
            document.querySelector('#id_disposisi').value = get('id_disposisi')
        })
    })
</script>