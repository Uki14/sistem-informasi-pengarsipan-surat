                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php echo count($this->db->get('suratmasuk')->result()) ?>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php echo count($this->db->get('suratkeluar')->result()) ?>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        <i class="fas fa-envelope fa-2x text-gray-300"></i>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php echo count($this->db->get('indeks')->result()) ?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php echo count($this->db->get('user')->result()) ?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                ...
                                <div class="dropdown no-arrow">
                                    <a href="<?= base_url('suratmasuk') ?>" class="text-dark" style="text-decoration: none">Lihat semua</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="suratmasuk" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php $no = 1;
                                            $sm_today = $this->db->get_where('suratmasuk', ['tanggal_masuk' => date('Y-m-d')])->result();
                                            foreach ($sm_today as $sm) : ?>
                                                <tr>
                                                    <td><?= $no++; ?></td>
                                                    <td><?= $sm->no_suratmasuk; ?></td>
                                                    <td><?= $sm->judul_suratmasuk; ?></td>
                                                    <td><?= $this->db->get_where('indeks',  ['id_indeks' => $sm->id_indeks])->row()->judul_indeks; ?></td>
                                                    <td><?= $sm->asal_surat; ?></td>
                    ...
                    <div class="col-xl-6 col-lg-7">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                ...
                                <div class="dropdown no-arrow">
                                    <a href="<?= base_url('suratkeluar') ?>" class="text-dark" style="text-decoration: none">Lihat semua</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="suratkeluar" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            $sk_today = $this->db->get_where('suratkeluar', ['tanggal_keluar' => date('Y-m-d')])->result();
                                            foreach ($sk_today as $sk) : ?>
                                                <tr>
                                                    <td><?= $no++; ?></td>
                                                    <td><?= $sk->no_suratkeluar; ?></td>
                                                    <td><?= $sk->judul_suratkeluar; ?></td>
                                                    <td><?= $this->db->get_where('indeks',  ['id_indeks' => $sk->id_indeks])->row()->judul_indeks; ?></td>
                                                    <td><?= $sk->tujuan; ?></td>
