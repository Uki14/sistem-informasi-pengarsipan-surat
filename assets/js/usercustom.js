$(document).ready(function () {
	...
	$("#hapussm").on("show.bs.modal", function (e) {
		...
		$("#hps-id-suratmasuk").attr(
			"href",
			"https://localhost/e-arsip-ci/admin/hapussm/" + id_suratmasuk
		);
	...
	$("#hapusdisp").on("show.bs.modal", function (e) {
		...
		$.ajax({
			...
			type: "POST",
			success: function (data) {
				$("#hps-id-disposisi").attr(
					"href",
					"http://localhost/e-arsip-ci/admin/hapusdisp/" + id_disposisi
				);
			},
		})
			.done(function () {
	...
	$("#hapussk").on("show.bs.modal", function (e) {
		...
		$("#hps-id-suratkeluar").attr(
			"href",
			"https://localhost/e-arsip-ci/admin/hapussk/" + id_suratkeluar
		);
	...
	$("#hapusindeks").on("show.bs.modal", function (e) {
		...
		$("#hps-id-indeks").attr(
			"href",
			"https://localhost/e-arsip-ci/admin/hapusindeks/" + id_indeks
		);
	...
	$("#hapususer").on("show.bs.modal", function (e) {
		...
		$("#hps-id-user").attr(
			"href",
			"http://localhost/e-arsip-ci/admin/hapususer/" + id_user
		);
	});
